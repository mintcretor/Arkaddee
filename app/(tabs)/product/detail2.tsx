...
interface FiltrationStep {
    ...
    description2Key?: string; // Optional key for translation
    description3Key?: string; // Optional key for translation
    description4Key?: string; // Optional key for translation
    description5Key?: string; // Optional key for translation
}
...
const ProductDetail2Page: React.FC = () => {
    ...
    const filtrationSteps: FiltrationStep[] = [
        {
            ...
            titleKey: 'ProductERV.HEPA_H13',
            descriptionKey: 'ProductERV.Filters_dust_99_95',
            description2Key: 'ProductERV.filter_not_washable',
            description3Key: 'ProductERV.filter_change_yearly',
            description4Key: '',
            description5Key: '',
        },
        {
            ...
            titleKey: 'ProductERV.Activated_Carbon',
            descriptionKey: 'ProductERV.filter_large_medium_dust',
            description2Key: 'ProductERV.filter_odor',
            description3Key: 'ProductERV.filter_washable',
            description4Key: 'ProductERV.filter_wash_six_months',
            description5Key: 'ProductERV.filter_change_two_years',
        },
        {
            id: 3,
            image: require('@/assets/images/product/pre_fliter.png'),
            titleKey: 'ProductERV.Pre_Filter',
            descriptionKey: 'ProductERV.filter_large_dust_insects',
            description2Key: 'ProductERV.filter_washable',
            description3Key: 'ProductERV.filter_wash_six_months',
            description4Key: 'ProductERV.filter_change_two_years',
            description5Key: '',
        },
        {
            id: 4,
            image: require('@/assets/images/product/UV lamp.png'),
            titleKey: 'ProductERV.UVc_Lamp',
            descriptionKey: 'ProductERV.filter_uvc_description',
            description2Key: '',
            description3Key: '',
            description4Key: '',
            description5Key: '',
    ...
    const specifications: Specification[] = [
        { labelKey: 'ProductERV.room_size', ppv160t_value: '32', ppv160t_unit_key: 'ProductERV.sq_m', ppv250_value: '50', ppv250_unit_key: 'ProductERV.sq_m' },
        { labelKey: 'ProductERV.fan_level', ppv160t_value: 'HIGH | MID | LOW', ppv250_value: 'HIGH | MID | LOW' },
    ...
    const warrantyIcons: WarrantyIcon[] = [
        { id: 'warranty1', icon: require('@/assets/images/icons/icon4.png'), labelKey: 'ProductERV.warranty_body' },
        { id: 'warranty2', icon: require('@/assets/images/icons/icon3.png'), labelKey: 'ProductERV.warranty_motor' },
        { id: 'warranty3', icon: require('@/assets/images/icons/icon5.png'), labelKey: 'ProductERV.warranty_control_panel' },
    ];
        ...
        <View style={styles.container}>
            ...
            <SafeAreaView style={styles.safeArea}>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.sectionContainer}>
                        <View style={styles.priceTable}>
                            <View style={styles.priceTableHeader}>
                                ...
                                <Text style={[styles.priceTableCell, styles.headerText]}> {t('ProductERV.price')} </Text>
                            </View>
                            ...
                            <View style={styles.priceTableRow}>
                                <Text style={[styles.priceTableCell2, { flex: 2 }]}> * {t('ProductERV.note_vat_install')} *</Text>
                            </View>
                        </View>
                        <TouchableOpacity
                    ...
                    <View style={styles.sectionContainer}>
                        <Text style={styles.sectionTitle}>{t('ProductERV.system_filter')}</Text>
                        {filtrationSteps.map((step) => (
                            <View key={step.id} style={styles.filtrationStep}>
                                ...
                                <View style={styles.filtrationTextContent}>
                                    ...
                                    {step.descriptionKey ? <Text style={styles.filtrationDescription}> • {t(step.descriptionKey)}</Text> : null}
                    ...
                    <View style={styles.sectionContainer}>
                        <Text style={styles.sectionTitle}> {t('ProductERV.specifications_title_erv')}</Text>
                        <View style={styles.specTable}>
                            <View style={styles.specTableHeader}>
                                <Text style={[styles.specTableCell, styles.headerText, { flex: 2 }]}>{t('ProductERV.model_label')}</Text>
                                <Text style={[styles.specTableCell, styles.headerText, { flex: 2 }]}>ERV 150</Text>
                    ...
                    {/* Warranty Section */}
                    <View style={styles.sectionContainer}>
                        <Text style={styles.sectionTitle}> {t('ProductERV.warranty_title')}</Text>
...
const styles = StyleSheet.create({
    container: {
        ...
        marginTop: Platform.OS === 'ios' ? 35 : 34, // Adjust if necessary
    ...
    productName: {
        ...
        color: '#2563EB',
        marginBottom: 8,
        textAlign: 'center', // Keep center for title
    ...
    productTagline: {
        ...
        color: '#333333',
        marginBottom: 10,
        textAlign: 'center', // Keep center for tagline
        width: '100%', // Ensure it takes full width for centering
    },
    productDescription: {
        fontSize: 14,
        color: '#666666',
        // textAlign: 'center', // Removed center alignment for bullet points
        lineHeight: 22,
